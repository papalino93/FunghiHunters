  ...
  return (
    ...
    >
      ...
      >
        ...
        {/*
          * Lo stesso segno dell'icona, senza il suo quadrato verde: qui la scena è già il bosco.
          * `relative` lo porta sopra la sagoma degli alberi, che è posizionata in assoluto e verrebbe
          * altrimenti dipinta sopra di lui, coprendo la punta e l'ombra del segnaposto.
          */}
        <span className="relative flex">
          <BrandMark size={88} idPrefix="welcome" />
        </span>
